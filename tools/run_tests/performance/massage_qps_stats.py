...
def massage_qps_stats(scenario_result):
  for stats in scenario_result["serverStats"] + scenario_result["clientStats"]:
    ...
    stats["core_closure_init"] = massage_qps_stats_helpers.counter(core_stats, "closure_init")
    stats["core_closure_sched"] = massage_qps_stats_helpers.counter(core_stats, "closure_sched")
    stats["core_closure_run"] = massage_qps_stats_helpers.counter(core_stats, "closure_run")
    stats["core_closure_sched_exec_ctx"] = massage_qps_stats_helpers.counter(core_stats, "closure_sched_exec_ctx")
    stats["core_colosure_run_exec_ctx"] = massage_qps_stats_helpers.counter(core_stats, "colosure_run_exec_ctx")
    stats["core_combiner_closure_run"] = massage_qps_stats_helpers.counter(core_stats, "combiner_closure_run")

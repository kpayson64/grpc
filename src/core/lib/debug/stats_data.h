...
typedef enum {
  ...
  GRPC_STATS_COUNTER_CLOSURE_INIT,
  GRPC_STATS_COUNTER_CLOSURE_SCHED,
  GRPC_STATS_COUNTER_CLOSURE_RUN,
  GRPC_STATS_COUNTER_CLOSURE_SCHED_EXEC_CTX,
  GRPC_STATS_COUNTER_COLOSURE_RUN_EXEC_CTX,
  GRPC_STATS_COUNTER_COMBINER_CLOSURE_RUN,
...
#define GRPC_STATS_INC_CLOSURE_INIT() GRPC_STATS_INC_COUNTER(GRPC_STATS_COUNTER_CLOSURE_INIT)
#define GRPC_STATS_INC_CLOSURE_SCHED() GRPC_STATS_INC_COUNTER(GRPC_STATS_COUNTER_CLOSURE_SCHED)
#define GRPC_STATS_INC_CLOSURE_RUN() GRPC_STATS_INC_COUNTER(GRPC_STATS_COUNTER_CLOSURE_RUN)
#define GRPC_STATS_INC_CLOSURE_SCHED_EXEC_CTX() GRPC_STATS_INC_COUNTER(GRPC_STATS_COUNTER_CLOSURE_SCHED_EXEC_CTX)
#define GRPC_STATS_INC_COLOSURE_RUN_EXEC_CTX() GRPC_STATS_INC_COUNTER(GRPC_STATS_COUNTER_COLOSURE_RUN_EXEC_CTX)
#define GRPC_STATS_INC_COMBINER_CLOSURE_RUN() GRPC_STATS_INC_COUNTER(GRPC_STATS_COUNTER_COMBINER_CLOSURE_RUN)

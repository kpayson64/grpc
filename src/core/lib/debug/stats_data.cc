...
const char *grpc_stats_counter_name[GRPC_STATS_COUNTER_COUNT] = {
  ...
  "closure_sched",
  "closure_run",
  "closure_sched_exec_ctx",
  "colosure_run_exec_ctx",
  "combiner_closure_run",
  "syscall_poll",
  "syscall_wait",
  "pollset_kick",
...
const char *grpc_stats_counter_doc[GRPC_STATS_COUNTER_COUNT] = {
  ...
  "Number of closures initialized",
  "Number of closures scheduled",
  "Number of closures run",
  "Number of closures sched on exec_ctx",
  "Number of closures run on exec_ctx",
  "Number of closures run/scheduled on a combiner",
